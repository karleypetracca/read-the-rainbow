...
class BookModel {
    ...
    static async newReview(users_id, book_id, review_title, review_stars, review_review) {
        try {
            const response = await db.one(`
                INSERT INTO review (users_id, book_id, stars, title, review)
                VALUES ($1, $2, $3, $4, $5)
                RETURNING id`,
                [users_id, book_id, review_stars, review_title, review_review]
            );
            return response
        } catch (error) {
